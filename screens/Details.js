...
import {var1} from '../components/src/components/LocationItem';
          ...
          <Card style={{flex: 0}}>
            ...
            <CardItem>
              <Body>
                ...
                {/* <Text source={{uri: 'https://maps.googleapis.com/maps/api/place/details/json?place_id=${var1}&fields=name,rating,formatted_phone_number,adr_address&key=AIzaSyB83SfaccVha2jO_M3UD9_ly5x7I2nbMpo'}}>
                {call}
                </Text> */}
                <Text>{var1}</Text>
              </Body>
